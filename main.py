    ...
    def main(self):
        ...
        for document in self.get_documents():
            for page in range(1,document.pages+1):
                ...
                # Generate mandatory PII Detection Lists
                ssn_list = parsed_text.ssn_number
                # ssn_list = list(set(CR.ssn_number(text))) uses crim
                cc_list = parsed_text.credit_cards
                # cc_list = list(set(CR.credit_cards(text))) uses crim
                ...
                try:
                    ...
                    if detect_address is True:
                        address_list = address_list + list(set(CR.street_addresses(text))) + list(set(CR.po_boxes(text)))
